...
class database
{
	...
	private function configure( $args )
	{
		...
		else if ( ! in_array( $args['driver'], \PDO::getAvailableDrivers() ) )
	...
	private function params()
	{
		...
		else if ( in_array($q, ['INSERT', 'REPLACE'] ) )
